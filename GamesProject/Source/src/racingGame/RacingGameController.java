...
public class RacingGameController implements CartMoveDelegate {
    ...
    public RacingGameController(Stage stage, MasterController presentingController) {
        ...
        cart0.setCartMoveDelegate(this);

        cart1 = new RaceCart(1, 120, 160);
        cart1.setCartMoveDelegate(this);

        cart2 = new RaceCart(2, 95, 190);
        cart2.setCartMoveDelegate(this);
    ...
    private void checkCarCheckpoint(int number, double x, double y) {
        if (carCheckpoints[number] == 0 && check1.contains(x, y)) {
        ...
        } else if (carCheckpoints[number] == 1 && check2.contains(x, y)) {
        ...
        } else if (carCheckpoints[number] == 2 && check3.contains(x, y)) {
        ...
        } else if (carCheckpoints[number] == 3 && check0.contains(x, y)) {
